...
volatile LONG     __SK_Init       = FALSE;
         ...
         bool     g_ExternalHost_DisableAllSKUI = true;
...
SK_EndBufferSwap (HRESULT hr, IUnknown* device, SK_TLS* pTLS)
{
  ...
  if (SK_Input_HasInstalledLowLevelKeyboardHook () && (SK_IsDebuggerPresent () || config.compatibility.disallow_ll_keyhook))
  {
...
SK_LazyGlobal <concurrency::concurrent_unordered_map <const wchar_t*, SK_ProfiledTask_Accum>> SK_ProfileAccumulator;
